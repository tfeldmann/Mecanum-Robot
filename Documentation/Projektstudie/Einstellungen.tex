...
\lstdefinestyle{eclipse}{
    ...
    morekeywords={STATES, STATEMACHINE, STATE_ENTER, STATE_LOOP, STATE_LEAVE, END_OF_STATE, END_STATEMACHINE,addButton, Sensor, bool, Serial1, Serial, SerialCommand, CmdListener, NULL, STOP, DOWN, UP, MOVE, STEP, CRV, FDZ, RESET, DISCONNECT, CONNECT, TouchLib, LightBarrier, ForceSensor, Stepmotor, HardwareController, bool, Direction, Stepmode},
