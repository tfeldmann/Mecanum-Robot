...
\begin{align*}
    ...
    \underline{v}(t) &= v_0
        ...
        \end{bmatrix}
\end{align*}
Der Roboter behält dabei seine Geschwindigkeit über die gesamte Kreisfahrt bei, da gilt $betrag(\underline{v}) = const$. Die Fahrt wird gestoppt, wenn gilt $v_x < 0$, also nach dem geforderten Viertelkreis.
