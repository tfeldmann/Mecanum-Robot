...
Für eine Drehung im Uhrzeigersinn drehen Rad eins und zwei rückwärts, Rad drei und vier vorwärts. Für eine Drehung gegen den Uhrzeigersinn entsprechend umgekehrt.
\begin{align*}
...
Die Steuerung des Roboters übernimmt ein Arduino Uno mit einem CAN-BUS Shield der Firma Sparkfun, die Programmierung erfolgt in C.

Die drei Kreisfahrten werden im Programm implizit, nicht iterativ hinterlegt. Das sorgt für ruckfreie Fahrwege
