...
\todo[caption={Koordinatentransformation in Ergebnisdiskussion}]{berechnung der Koordinatentransformation irrelevant für die Roboterposition, zu ungenau, optisches messsystem(Camera in der Halle)}
